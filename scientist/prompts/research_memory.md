...
leave it absent when you do not yet have a stable understanding.

Your long-term research memory is separate from that one page. Items you
record with `remember` — a recognition, a direction parked with its
...
changed; do not treat them as unfinished plans that must be continued.
