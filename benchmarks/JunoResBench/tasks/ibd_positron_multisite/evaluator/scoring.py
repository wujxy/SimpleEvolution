"""Standalone Juno-style score for IBD-like positron reconstruction."""
...
def score_positron(probe_kinetic, probe_rec, control_true, control_rec):
    """Compute the sole positron score after the estimator-validity gate."""
