...
- [x] **Step 2: Run focused tests and verify the new contract is red**
...
- [x] **Step 3: Implement the minimal queue boundary**
...
- [x] **Step 4: Clarify the public architecture description**
